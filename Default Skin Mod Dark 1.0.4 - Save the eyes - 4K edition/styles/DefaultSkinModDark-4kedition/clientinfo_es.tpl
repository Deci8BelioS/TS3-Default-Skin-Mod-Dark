	...
	<tr>
		<td>
			<table width="330" class="Infoframe_nospace">
				...
				<tr><td class="Infoframe_label">Versión: </td><td class="Infoframe_list"><span title="%%CLIENT_VERSION_STATE%%">%%CLIENT_VERSION%%</span> en: <span title="%%CLIENT_PLATFORM%%"><img src="styles:/DefaultSkinModDark-4kedition/imagesinfo/%%CLIENT_PLATFORM%%.png" alt="" title="%%CLIENT_PLATFORM%%" /></span></td></tr>
				...
				<tr><td class="Infoframe_label">Conectado el: </td><td class="Infoframe_list">%%CLIENT_LASTCONNECTED%%</td> </tr>
