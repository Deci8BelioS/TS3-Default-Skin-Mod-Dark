...
<table class="Infoframe_table">
  ...
  <tr title="%%SERVER_VERSION%%">
   ...
   <td class="Infoframe_list">%%SERVER_VERSION_SHORT%% in <img src="styles:/DefaultSkinModDark-4kedition/imagesinfo/%%SERVER_PLATFORM%%.png" alt="" title="%%SERVER_PLATFORM%%" /></td>
  </tr>
  <tr>
