	...
	<tr>
		...
		<td>
			<table width="100%" class="Infoframe_nospace">
				...
				<tr><td class="Infoframe_label">Cifrado de voz:</td> <td class="Infoframe_list"> %%CHANNEL_VOICE_DATA_ENCRYPTED%% <img src="styles:/DefaultSkinModDark-4kedition/imagesinfo/encrypted_12x12.png" alt="%%CHANNEL_VOICE_DATA_ENCRYPTED_FLAG%%" /></td></tr>
